...
def one():
  ...
  gamma_image = gammaCorrection(image, 3, 1)
  ...
  ax[1].set_title("Gamma corrected grayscale image")
  ax[1].axis("off")
...
def two():
  ...
  red_gamma = gammaCorrection(red, 0.5, 1)
  green_gamma = gammaCorrection(green, 0.5, 1)
  blue_gamma = gammaCorrection(blue, 0.5, 1)
...
def three():
  ...
  value_gamma = gammaCorrection(value, 0.5, 1)
